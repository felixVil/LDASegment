...
%error('Tracker not configured! Please edit the tracker_LDATracker.m file.'); % Remove this line after proper configuration
...
tracker_command = generate_matlab_command('LDATracker', {'D:\Felix\Aharon Bar Hillel Repo\Sandboxes\Felix\vot-toolkit-master'});
